                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-input type="text" id="apellidos_completos" name="apellidos_completos"
                                            :value="$empleado->apellidos_completos" />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$tipos_documentos" identifier="id_tipo_documento" label="tipo_documento"
                                            id="tipo_documento" name="tipo_documento">
                                            <option value="{{ $empleado->tipo_documento_id }}" selected>
                                                {{ $empleado->tipoDocumento->tipo_documento }}</option>
                                        </x-select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$departamentos" identifier="id_departamento" label="departamento" id="departamento" name="departamento">
                                            <option value="{{ $empleado->municipio->departamento->departamento }}" selected>
                                                {{ $empleado->municipio->departamento->departamento }}</option>
                                        </x-select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$municipios" identifier="id_municipio" label="municipio" id="municipio"
                                            name="municipio">
                                            <option value="{{ $empleado->municipio->id_municipio }}" selected>
                                                {{ $empleado->municipio->municipio }}</option>
                                        </x-select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$tipos_sangre" identifier="id_tipo_sangre" label="tipo_sangre"
                                            id="tipo_sangre" name="tipo_sangre">
                                            <option value="{{ $empleado->tipo_sangre }}" selected> {{ $empleado->tipo_sangre }}
                                            </option>
                                        </x-select>
                            ...
                            <div class="tab-pane fade form-section" id="informacion-laboral" role="tabpanel" aria-labelledby="informacion-laboral-tab">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$cargos_empleados" identifier="id_cargo_empleado" label="cargo_empleado"
                                            id="cargo_empleado" name="cargo_empleado">
                                            <option value="{{ $empleado->cargo_empleado_id }}" selected>
                                                {{ $empleado->cargoEmpleado->cargo_empleado }}</option>
                                        </x-select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$estados" identifier="id_estado" label="estado" id="estado"
                                            name="estado">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-input type="date" id="fecha_inicio_contrato" name="fecha_inicio_contrato"
                                            :value="$empleado->fecha_inicio_contrato" />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-input type="date" id="fecha_periodo_prueba" name="fecha_periodo_prueba"
                                            :value="$empleado->fecha_periodo_prueba ?? ''" />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-input type="date" id="fecha_fin_contrato" name="fecha_fin_contrato"
                                            :value="$empleado->fecha_fin_contrato ?? ''" />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$tipos_contratos" identifier="id_tipo_contrato" label="tipo_contrato"
                                            id="tipo_contrato" name="tipo_contrato">
                                            <option value="{{ $empleado->tipo_contrato_id }}" selected>
                                                {{ $empleado->tipoContrato->tipo_contrato }}</option>
                                        </x-select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$niveles_educativos" identifier="id_nivel_educativo" label="nivel_educativo"
                                            id="nivel_educativo" name="nivel_educativo">
                                            <option value="{{ $empleado->nivel_educativo_id }}" selected>
                                                {{ $empleado->nivelEducativo->nivel_educativo }}</option>
                                        </x-select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <x-select :elements="$arls" identifier="id_arl" label="nombre_arl" id="arl"
                                            name="arl">
                                            <option value="{{ $empleado->arl_id }}" selected> {{ $empleado->arl->nombre_arl }}
                                            </option>
                                        </x-select>
